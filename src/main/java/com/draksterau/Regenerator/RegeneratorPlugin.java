...
/*            if (getServer().getPluginManager().isPluginEnabled("WorldEdit")) {
    ...
    public void disablePlugin() {
        ...
        try { RConfig.connectionSQL.close(); } catch(SQLException sqlSe) { utils.throwMessage(MsgType.WARNING, sqlSe.getMessage()); }
        try { RConfig.statementSQLcon.close(); } catch(SQLException sqlSe) { utils.throwMessage(MsgType.WARNING, sqlSe.getMessage()); }
        //try { RConfig.rs.close(); } catch(SQLException sqlSe) { utils.throwMessage(MsgType.WARNING, sqlSe.getMessage()); }
